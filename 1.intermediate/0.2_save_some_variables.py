...
flags.DEFINE_string('save_path', 'ckpt_encoder', 'location to store models')
flags.DEFINE_string('tfrecord_dir', '../0.basics/tfrecords', 'location to store tfrecords')
flags.DEFINE_string('summary_dir', 'summary', 'location to store summary files')
flags.DEFINE_boolean('resume', False, 'resume training') # resume training for another 10 epoch
FLAGS = flags.FLAGS
